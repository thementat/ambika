...
static const prog_Parameter parameters[kNumParameters] PROGMEM = {
  ...
  // 75
  { PARAMETER_LEVEL_MULTI,
    PRM_MULTI_MPE_ENABLED,
    UNIT_BOOLEAN, 0, 1,
    1, 0, 0xff, 0xff,
    STR_RES_MPE, STR_RES_MPE_ENABLED, STR_RES_PART },

  // 76
  { PARAMETER_LEVEL_MULTI,
    PRM_MULTI_MPE_CHANNELS,
    UNIT_UINT8, 1, 15,
    1, 0, 0xff, 0xff,
    STR_RES_CHNS, STR_RES_MEMBER_CHANNELS, STR_RES_PART },
  ...
  { PARAMETER_LEVEL_MULTI,
    ...
    UNIT_UINT8, 0, 63,
    1, 0, 0xff, 0xff,
    STR_RES_BRNG, STR_RES_BEND_RANGE, STR_RES_PART },
